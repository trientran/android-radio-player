...
public class RadioService extends Service implements Player.EventListener, AudioManager.OnAudioFocusChangeListener {
    ...
    public static final String ACTION_PLAY = "com.trien.player.ACTION_PLAY";
    public static final String ACTION_PAUSE = "com.trien.player.ACTION_PAUSE";
    public static final String ACTION_STOP = "com.trien.player.ACTION_STOP";
    ...
    public void onCreate() {
        ...
        strLiveBroadcast = getResources().getString(R.string.notification_title);
...
*/
        ...
        DataSource.Factory dataSourceFactory =
                new DefaultDataSourceFactory(this, Util.getUserAgent(this, getClass().getSimpleName()));
